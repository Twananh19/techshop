...
@section('title', 'Sửa sản phẩm kho')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Sửa sản phẩm kho: {{ $item->sku }}</h1>
    ...
    <form action="{{ route('admin.inventory.update', $item) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="stock_quantity" id="stock_quantity" value="{{ old('stock_quantity', $item->stock_quantity) }}" min="0" required
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ route('admin.inventory.show', $item) }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                Hủy
            </a>
